...
func (pane *ProjectPane) addDynamicLists() {
	...
	/*
		...
		pane.list.AddItem("- Upcoming", "", 0, func() { pane.core.taskPane.LoadDynamicList("upcoming") })
		pane.list.AddItem("- Unscheduled", "", 0, func() { pane.core.taskPane.LoadDynamicList("unscheduled") })
	*/
}
