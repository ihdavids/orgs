...
* Capture Plugin  The capture tool can take a quick snippet of text  and turn it into a targetted org entry in a file  of your choosing. With Refile capability Capture  can be a major asset when helping you organize your  thoughts. ** Configuration  Configuration for the system is done through  the captureTemplates entry in your orgs.yaml file:  #+BEGIN_SRC yaml         captureTemplates:      - name: "BasicEntry"        type: "entry"        target:           type: "file+headline"          filename: "test.org"          id: "Captures"      - name: "BasicItem"        type: "item"        target:           type: "file+headline"          filename: "test.org"          id: "Captures"      - name: "BasicCheckItem"        type: "checkitem"        target:           type: "file+headline"          filename: "test.org"          id: "Captures"      - name: "BasicPlain"        type: "plain"        target:           type: "file+headline"          filename: "test.org"          id: "Captures"      - name: "BasicTable"        type: "table-line"        target:           type: "file+headline"          filename: "test.org"          id: "Captures"      - name: "Datetree"        type: "entry"        target:           type: "file+datetree"          filename: "test.org"          id: "Captures"          template: ":PROPERTIES:                         :DATE: {{date}}                     :END:                     {{CONTENT}}                    "      - name: "OlpDatetree"        type: "entry"        target:           type: "file+olp+datetree"          filename: "test.org"          id: "Captures::Level1::Level2"    #+END_SRC
